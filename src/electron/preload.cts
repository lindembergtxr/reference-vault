...
electron.contextBridge.exposeInMainWorld('api', {
    ...
    createWorkspace: (args) => ipcInvoke('createWorkspace', args),
    selectWorkspace: (args) => ipcInvoke('selectWorkspace', args),
    setTheme: (theme: ConfigDataTheme) => ipcInvoke('setTheme', theme),
    setDestinationFolder: (args) => ipcInvoke('setDestinationFolder', args),
    ...
    batchDeleteImages: (args) => ipcInvoke('batchDeleteImages', args),
    countImages: () => ipcInvoke('countImages'),
    exportDB: (args) => ipcInvoke('exportDB', args),
